...
public class TwoPage extends BasePage implements OnClickListener
{
	private final static String TAG = "TowPage";
//	private Context mContext;
	private ActivityInterface mAif;

	public TwoPage(Context context, View view, ActivityInterface aif)
	{
...
//		View btn_show_home = view.findViewById(R.id.btn_show_home);
//		btn_show_home.setOnClickListener(this);
	}
	...
	{
//		mAif.showJumpPrevious(getMyViewPosition(), Configs.VIEW_POSITION_HOME, null);
	}
}
