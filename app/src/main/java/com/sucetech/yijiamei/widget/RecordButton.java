...
//			dialogImg.setImageResource(R.drawable.record_animate_01);
                dialogImg.setImageResource(R.mipmap.im_microphone);
...
//        toast.setDuration(500);//设置显示时间
    ...
    private void setDialogImage() {
        ...
        if (voiceValue < 1000.0) {
            dialogImgSize.setBackgroundResource(R.mipmap.chat_volume_01);
        } else if (voiceValue > 1000.0 && voiceValue < 3000.0) {
            dialogImgSize.setBackgroundResource(R.mipmap.chat_volume_02);
        } else if (voiceValue > 3000.0 && voiceValue < 5000.0) {
            dialogImgSize.setBackgroundResource(R.mipmap.chat_volume_03);
        } else if (voiceValue > 5000.0 && voiceValue < 7000.0) {
            dialogImgSize.setBackgroundResource(R.mipmap.chat_volume_04);
        } else if (voiceValue > 7000.0 && voiceValue < 9000.0) {
            dialogImgSize.setBackgroundResource(R.mipmap.chat_volume_05);
        } else if (voiceValue > 11000.0 && voiceValue < 13000.0) {
            dialogImgSize.setBackgroundResource(R.mipmap.chat_volume_06);
        } else if (voiceValue > 13000.0 && voiceValue < 15000.0) {
            dialogImgSize.setBackgroundResource(R.mipmap.chat_volume_07);
        } else if (voiceValue > 15000.0 && voiceValue < 17000.0) {
            dialogImgSize.setBackgroundResource(R.mipmap.chat_volume_08);
        } else if (voiceValue > 17000.0 && voiceValue < 19000.0) {
            dialogImgSize.setBackgroundResource(R.mipmap.chat_volume_09);
        } else if (voiceValue > 19000.0 && voiceValue < 20000.0) {
            dialogImgSize.setBackgroundResource(R.mipmap.chat_volume_10);
        } else if (voiceValue > 20000.0 && voiceValue < 22000.0) {
            dialogImgSize.setBackgroundResource(R.mipmap.chat_volume_11);
        } else if (voiceValue > 22000.0) {
            dialogImgSize.setBackgroundResource(R.mipmap.chat_volume_12);
        }
